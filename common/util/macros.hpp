...
#define _CLOTH__DEFAULT_EQ_COMPARISON(Member) &&(this->Member == rhs.Member)

#define DEFAULT_EQUALITY(Class, ...)                                                               \
  bool operator==(const Class& rhs)                                                                \
  {                                                                                                \
    return true FOR_EACH(_CLOTH__DEFAULT_EQ_COMPARISON, __VA_ARGS__);                              \
  }                                                                                                \
  bool operator!=(const Class& rhs)                                                                \
  {                                                                                                \
    return !(*this == rhs);                                                                        \
...
#define GET_MACRO_15(_1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, NAME, ...)  \
  NAME

#define SWITCH_FOR_VARARGS_1(NO_VARARGS, VARARGS, ...)                                             \
  GET_MACRO_15(__VA_ARGS__, VARARGS, VARARGS, VARARGS, VARARGS, VARARGS, VARARGS, VARARGS,         \
               VARARGS, VARARGS, VARARGS, VARARGS, VARARGS, VARARGS, VARARGS, NO_VARARGS, NONE)    \
  (__VA_ARGS__)
...
#define FOR_EACH(action, ...)                                                                      \
  GET_MACRO_15(__VA_ARGS__, FE_15, FE_14, FE_13, FE_12, FE_11, FE_10, FE_9, FE_8, FE_7, FE_6,      \
               FE_5, FE_4, FE_3, FE_2, FE_1, NONE)                                                 \
  (action, __VA_ARGS__)
...
#define FOR_EACH_LAST(action, args, ...)                                                           \
  GET_MACRO_15(__VA_ARGS__, FEL_15, FEL_14, FEL_13, FEL_12, FEL_11, FEL_10, FEL_09, FEL_08,        \
               FEL_07, FEL_06, FEL_05, FEL_04, FEL_03, FEL_02, FEL_01, NONE)                       \
